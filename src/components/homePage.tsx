...
export default function HomePage() {
    return (
        <div className="w-full ml-6 mr-6 mb-6 h-[700px] rounded-lg block" style={{ backgroundColor: "#5683d2" }}>
            <div className="w-[350px] h-[180px] p-6 bg-white max-w-sm text-center rounded-2xl shadow-2xl mx-auto mt-6 balance">
