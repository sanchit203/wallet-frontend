            ...
            <div className="flex justify-center">
                <div className="w-[500px] block table mt-8 mb-8 p-4 bg-white border border-gray-200 rounded-2xl shadow-2xl" >
                    ...
                    <a href="/" className="flex justify-center"><img className="w-30 h-8 mb-8" src="/images/logo.png" alt="logo" /></a>
                        <h1 className="text-xl font-bold leading-tight mb-6 tracking-tight text-gray-600 md:text-2xl">Create Account</h1>
                        <form className="space-y-4 md:space-y-6" action="/">
                            <div>
                                <label htmlFor="name" className="block mb-1 mt-4 text-sm font-medium">Name</label>
                            ...
                            <button type="submit" className="w-full border hover:bg-blue-500 hover:text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign up</button>
